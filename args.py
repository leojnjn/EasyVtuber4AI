...
parser.add_argument('--wave', type=str, default='y')  # leojnjn 给音频做输入框
parser.add_argument('--lip', type=str, default='y')  # leojnjn 给口型做输入框
...
parser.add_argument('--AI_input', type=str)
